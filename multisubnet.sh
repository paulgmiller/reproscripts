...
export rg="mutiagent"
export l="westus2"
export vnet="multiagent"
export c="podsubnetdemoC"
...
az network vnet subnet create -g $rg --vnet-name $vnet --name s1 --address-prefixes 10.240.0.0/16 -o none
az network vnet subnet create -g $rg --vnet-name $vnet --name s2 --address-prefixes 10.241.0.0/16 -o none
