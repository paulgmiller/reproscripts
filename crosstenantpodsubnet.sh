...
export vnet="paulnet"
export c="podsubnet"
export netsub="26ad903f-2330-429d-8389-864ac35c4350"

az account set -s $netsub
...
az aks create -n $c -g $rg -l $l --node-count 2 --yes --network-plugin azure -s Standard_D2a_v4 \
 --vnet-subnet-id /subscriptions/$netsub/resourceGroups/$rg/providers/Microsoft.Network/virtualNetworks/$vnet/subnets/vms \
 --pod-subnet-id /subscriptions/$netsub/resourceGroups/$rg/providers/Microsoft.Network/virtualNetworks/$vnet/subnets/pods \
