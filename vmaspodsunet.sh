...
export rg="paulbash2"
export l="eastus2euap"
export vnet="paulnetD"
export c="podsubnetbugbashD"
...
#create cluster
az aks create -n $c -g $rg -l $l --node-count 2 --yes --vm-set-type AvailabilitySet  --network-plugin azure \
