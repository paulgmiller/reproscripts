...
#create cluster
az aks create -n $c -g $rg -l $l --node-count 2 --yes --network-plugin azure --enable-addons virtual-node \
 --vnet-subnet-id /subscriptions/$s/resourceGroups/$rg/providers/Microsoft.Network/virtualNetworks/$vnet/subnets/vms \
 --aci-subnet-name /subscriptions/c1089427-83d3-4286-9f35-5af546a6eb67/resourceGroups/paulvk/providers/Microsoft.Network/virtualNetworks/paulnetF/subnets/vk
